---
title: "ItemList: Symbol-Driven Nested Terminal List Builder"
sidebarTitle: "Item List"
description: "Build nested, symbol-driven terminal lists with ItemList. Each item has a symbol, content, and optional sublist. Config cascades to sublists."
---
